...
Revised upward in [Step 2](02-the-optical-bench-test.md) to ~450 MB, once cropping moved into processing and the
...
[Contents](README.md) · [Step 2: The optical bench test →](02-the-optical-bench-test.md)
